...
//    }
    ...
    func createYesButton () {
        ...
        yesButton.frame = CGRectMake(45, 835, 310, 90)
    ...
    func createNoButton () {
        ...
        noButton.frame = CGRectMake(415, 835, 310, 90)
    ...
    func createLARCLabel () {
        ...
        let label = UILabel()
        label.text = "Would you like to see what forms of birth control will work for you, including LARCs?"
    ...
    func noPressed(sender: UIButton!) {
        ...
        quitAlert.title = "If you're finished viewing this information, tap Okay to exit this page."
        quitAlert.message = ""
